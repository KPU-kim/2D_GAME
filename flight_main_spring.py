...
def enter():
    global dragon, background1 , enemy_white , enemy_yellow, enemy_pink, enemy_green, Missiles_1, Missiles_2, ice_cragon, Enemy_Missile_List
...
def exit():
    global dragon, background1 , enemy_white , enemy_yellow, enemy_pink, enemy_green, Missiles_1, Missiles_2, ice_cragon, ui, Enemy_Missile_List, score
    del(dragon)
    del(score)
    del(background1)
    del(enemy_white)
